...
public class CustomCaldroidFragment extends DialogFragment {
    /**
     * Weekday conventions
     */
    public static int
    ...
    public void restoreDialogStatesFromKey(FragmentManager manager,
        ...
        CustomCaldroidFragment existingDialog = (CustomCaldroidFragment) manager
    ...
    public class DatePageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        private int getNext(int position) {
            return (position + 1) % CustomCaldroidFragment.NUMBER_OF_PAGES;
        }
        ...
        private int getPrevious(int position) {
            return (position + 3) % CustomCaldroidFragment.NUMBER_OF_PAGES;
        }
        ...
        public int getCurrent(int position) {
            return position % CustomCaldroidFragment.NUMBER_OF_PAGES;
        }
        ...
        public void onPageSelected(int position) {
            ...
            CaldroidGridAdapter currentAdapter = caldroidGridAdapters
                    .get(position % CustomCaldroidFragment.NUMBER_OF_PAGES);
